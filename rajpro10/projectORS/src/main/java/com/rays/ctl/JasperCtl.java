...
//	  @Autowired 
	...
	public void display(HttpServletRequest request, HttpServletResponse response)
		...
		String path = context
				.getRealPath("/projectORS/src/main/resources/report/ReportMeritlist.jrxml");
		/*
		 * "D:\sts workspace pro 10\projectORS\src\main\resources\report\ReportMeritlist.jrxml"
		 */
